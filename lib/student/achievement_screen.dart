...
class FetchMessageScreen extends StatefulWidget {
  const FetchMessageScreen();
                ...
                Column(
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemCount: groupedMessages[date],
                      itemBuilder: () {
      ...
      child: Card(
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: [
              if (image.isEmpty) Image.network(image),
              if (image.isEmpty) const SizedBox(width: 8),
              Padding(
