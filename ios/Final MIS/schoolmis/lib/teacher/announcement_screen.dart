...
class _TeacherAnnouncementScreenState extends State<TeacherAnnouncementScreen> {
  ...
  void _deleteAnnouncements(List<String> announcementIds) {
    for (var announcementId in announcementIds) {
  ...
  void _toggleMessageSelection(String announcementId) {
    setState(() {
      if (selectedMessages.contains(announcementId)) {
        selectedMessages.remove(announcementId);
      } else {
        selectedMessages.add(announcementId);
      }
    });
  }
